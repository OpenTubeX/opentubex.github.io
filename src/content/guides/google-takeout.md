...
The three Google Takeout UI screenshots are reproduced unchanged from [positron48's source images](https://github.com/positron48/youtube-history-analyzer/tree/master/images), published with the September 2025 article linked above. Google product visuals belong to Google and are shown for instructional purposes; they are not covered by the [FreeTube Docs MIT license](/docs-sources/freetube-license.txt). See [Google's educational-use guidance](https://about.google/brand-resource-center/guidance/). OpenTubeX is not affiliated with Google.
